            ...
            jQuery(document).ready(function ($) {
                ...
                $("#meuCarrinho").click(function () {
                    if (itensCarrinho.length === 0) {
                        ...
                        $("#modal-body-carrinho").html('<div class="container table-responsive-sm"> <table class="table"> <thead class="thead-dark"> <tr> <th>Produto</th> <th>Preço</th> <th>Quantidade</th> <th>Total</th> </tr> </thead> <tbody id="tabelaProdutos"> <tr> <td></td> <td></td> <td></td> <td style="font-weight: bold;"></td> </tr> </tbody> </table> </div>');
                        $.ajax({
                            url: "carrinho.php",
                            type: "POST",
                            data: 'id=' + itensCarrinho,
                            async: true,
                            dataType: "json",
                            beforeSend: function () {
