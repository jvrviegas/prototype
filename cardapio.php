        ...
        jQuery(document).ready(function ($) {
            ...
            $(".btn_close").click(function () {
                if ((controle2sabores % 2) != 0) {
                    Swal("Por favor, selecione dois sabores !");
                /*} else if (controle2sabores < 2 && controle2sabores > 0) {
                    ...
                    $("#pizza2sabores_pequena").modal('hide');
                }
            });
            ...
            $(".dois-sabores-pequena").click(function () {
                $('#pizza2sabores_pequena').modal('show');
            });
                            ...
                            <div class="orders">
                                <div class="container" id="lista_pizzas_tradicionais">
                                    <div class="row" style="margin-top: 10px;">
                                        <div><h3>Pequena</h3></div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="col-xs-6"><h4>Um sabor</h4></div>
                                        <div class="col-xs-6">
                                            <h4>R$16,99 <a data-toggle="collapse" href="#tradicional1sabor_pequena" style="margin-left: 20px;">Escolher</a></h4>
                                        </div>
                                        <div class="collapse fade" id="tradicional1sabor_pequena"><?php include "cardapios/manda_pizza/pizzas_tradicionais_pequena.php" ?></div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="col-xs-6"><h4>Dois sabores</h4></div>
                                        <div class="col-xs-6">
                                            <h4>------------<a class="dois-sabores-pequena" style="margin-left: 25px;">Escolher</a></h4>
                                        </div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        <div><h3>Grande</h3></div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="col-xs-6"><h4>Um sabor</h4></div>
                                        <div class="col-xs-6">
                                            <h4>R$26,99 <a data-toggle="collapse" href="#tradicional1sabor_grande" style="margin-left: 20px;">Escolher</a></h4>
                                        </div>
                                        <div class="collapse fade" id="tradicional1sabor_grande"><?php include "cardapios/manda_pizza/pizzas_tradicionais_grande.php" ?></div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="col-xs-6"><h4>Dois sabores</h4></div>
                                        <div class="col-xs-6">
                                            <h4>------------<a class="dois-sabores" style="margin-left: 25px;">Escolher</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="orders">
                                <div class="container" id="lista_pizzas_premium">
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="col-xs-6"><h4>Um sabor</h4></div>
                                        <div class="col-xs-6">
                                            <h4>R$26,99 <a data-toggle="collapse" href="#premium1sabor_pequena" style="margin-left: 20px;">Escolher</a></h4>
                                        </div>
                                        <div class="collapse fade" id="premium1sabor_pequena"><?php include "cardapios/manda_pizza/pizzas_premium_pequena.php" ?></div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="col-xs-6"><h4>Dois sabores</h4></div>
                                        <div class="col-xs-6">
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="col-xs-6"><h4>Um sabor</h4></div>
                                        <div class="col-xs-6">
                                            <h4>R$36,99 <a data-toggle="collapse" href="#premium1sabor_grande" style="margin-left: 20px;">Escolher</a></h4>
                                        </div>
                                        <div class="collapse fade" id="premium1sabor_grande"><?php include "cardapios/manda_pizza/pizzas_premium_grande.php" ?></div>
                                    </div>
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="col-xs-6"><h4>Dois sabores</h4></div>
                                        <div class="col-xs-6">
...
<?php include 'cardapios/manda_pizza/refrigerante_2,5l.php'; ?>
...
<?php include 'cardapios/manda_pizza/pizzas_2_sabores_pequena.php'; ?>
