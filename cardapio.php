                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            $.each(result, function (key, value) {
                                $("#tabelaProdutos").append("<tr> <td>" + value.produto + "</td> <td>" + value.preco + "</td> <td> <input type='number' name='number' class='qtd_item' id='quant' min='1' max='100' value='1' readonly> </td> </tr>");
                            });
        ...
        <div class="top-header">
            ...
            <div class="header-right">
                <div class="cart box_1">
                    <a id="meuCarrinho">
                        <h3><span class="simpleCart_total">$0.00</span> (<span id="quantidadeItens"> 0 </span>
...
<?php include "cardapios/manda_pizza/bebidas_modal.php"?>
