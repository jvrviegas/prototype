...
$pizzas_premium = $retorno->carregarProdutos($categoria);
foreach ($pizzas_premium as $produto) {
            ...
            <div class="special-info grid_1 simpleCart_shelfItem">
                <div class="pre-top">
                    ...
                    <div class="pr-right">
                        ...
                        <a class="itemCarrinho_pizza2sabores" id="<?php echo $produto['cod'];?>" >Adicionar</a>
